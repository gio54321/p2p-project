<script lang='ts'>
	...
	import { Navbar,
		...
		NavHamburger,
		Avatar,
		Dropdown, DropdownHeader, DropdownItem, DropdownDivider, Button} from 'flowbite-svelte';
...
<Navbar>
<NavBrand href="/">
	<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white">Hit and sunk!</span>
</NavBrand>
...
<Dropdown placement="bottom" triggeredBy="#avatar-menu">
	<DropdownHeader>
		...
		{:else}
			...
			<span class="block truncate font-semibold text-sm">{$selectedAccount}</span>
		{/if}
	</DropdownHeader>
	{#if !$connected}
